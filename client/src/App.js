...
function App() {
  ...
  const handleCategoryClick = (category) => {
    ...
    axios
      .get(`http://localhost:5000/api/providers/category/${category._id}`)
      .then((response) => {
  ...
  const handleSearch = (e) => {
    ...
    axios
      .get(
        `http://localhost:5000/api/providers/search?term=${searchTerm}&category=${
          ...
          {categories.map((category) => (
            <div
              ...
              style={{
                ...
                textAlign: "center",
                backgroundColor:
                  selectedCategory?.id === category.id ? "green" : "green",
              ...
              >
                {provider.images && (
                  ...
                  >
                    <img
                      src={
                        `http://localhost:5000/uploads/providers/` +
                        provider?.images[0]?.slice(19)
                      }
                      alt={provider.name}
                      style={{
                        width: "100%",
                ...
                <h2 style={{ margin: "0 0 10px 0", color: "#2E4057" }}>
                  {provider.name}
                </h2>
