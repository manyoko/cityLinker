...
function ProviderDetail() {
  ...
  const renderStars = (rating) => {
    return Array.from({ length: 5 }, (_, i) => (
      <span key={i} style={{ color: i < rating ? '#FFD700' : '#DDD', fontSize: '24px' }}>★</span>
    ));
  };
  ...
  const prevImage = (e) => {
    e.stopPropagation();
    if (provider.images && provider.images.length > 0) {
      const prevIndex = (activeImageIndex - 1 + provider.images.length) % provider.images.length;
  ...
  if (loading) return (
    <div style={{ 
      ...
      <div>
        ...
        <p style={{ fontSize: '18px', color: '#555' }}>Loading amazing content...</p>
        <style>{`
          @keyframes spin {
  ...
  if (!provider) return (
    <div style={{ 
      ...
      <p style={{ fontSize: '18px' }}>We couldn't find the provider you're looking for.</p>
      <Link to="/" style={{ 
        color: 'white', 
        textDecoration: 'none',
        background: 'green',
    ...
    <div style={{ 
      ...
      <div style={{ marginBottom: '2rem' }}>
        <Link to="/" style={{ 
          ...
          <span style={{ marginRight: '8px', fontSize: '20px' }}>←</span> Back to Providers
        </Link>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
                ...
                {heroImages.map((_, index) => (
                  <div 
                    ...
                    style={{
                      ...
                      borderRadius: '50%',
                      backgroundColor: index === currentHeroSlide ? 'white' : 'rgba(255, 255, 255, 0.5)',
                      margin: '0 6px',
                      cursor: 'pointer',
                      transition: 'all 0.3s ease',
                      boxShadow: index === currentHeroSlide ? '0 0 6px rgba(255, 255, 255, 0.8)' : 'none'
                    }}
                  />
                ))}
              </div>
            ...
            {heroImages.length > 1 && (
              <>
                <div 
                  onClick={() => {
                    const newIndex = (currentHeroSlide - 1 + heroImages.length) % heroImages.length;
          ...
          <div style={{
            ...
            <div style={{ fontSize: 'clamp(1rem, 3vw, 1.7rem)', marginBottom: '1rem' }}>
              {renderStars(provider.rating)}{' '}
              <span style={{ fontSize: 'clamp(0.8rem, 2vw, 1.2rem)', marginLeft: '10px' }}>({provider.reviewCount} reviews)</span>
            </div>
            {provider.location && (
              <div style={{ 
                display: 'flex', 
              ...
              {provider.images.slice(0, 6).map((img, index) => (
                ...
                >
                  ...
                  <div style={{
                    ...
                    color: 'white',
                    fontWeight: 'bold',
                    opacity: index === 3 && provider.images.length > 6 ? 1 : 0,
                    transition: 'opacity 0.3s ease',
                    display: 'flex',
                    justifyContent: 'center',
                    alignItems: 'center'
                  }}>
                    {index === 3 && provider.images.length > 6 && `+ ${provider.images.length - 6} more`}
                  </div>
                </div>
              ))}
            </div>
      ...
      {provider.image && provider.image.length > 0 && (
        <div style={{
          ...
          <div style={{ 
            ...
            <button onClick={toggleGalleryView} style={{
              background: 'green',
              color: 'white',
              border: 'none',
              padding: '10px 20px',
        ...
        <div style={{
          ...
          <div style={{ 
            ...
            {provider.services && provider.services.map((service, index) => (
              <div key={index} style={{
                padding: '1rem',
                borderBottom: index !== provider.services.length - 1 ? '1px solid #eee' : 'none'
              }}>
                <h4 style={{ 
                ...
                <tbody>
                  {provider.businessHours &&
                    Object.entries(provider.businessHours).map(([day, hours]) => (
                      <tr key={day}>
                        <td style={rowCellStyle}>{day.charAt(0).toUpperCase() + day.slice(1)}</td>
            ...
            {provider.socialMedia && Object.keys(provider.socialMedia).length > 0 ? (
              <div style={{
                ...
                {provider.socialMedia.facebook && (
                  <a href={provider.socialMedia.facebook} target="_blank" rel="noopener noreferrer" style={{
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    width: '3rem',
                ...
                {provider.socialMedia.instagram && (
                  <a href={provider.socialMedia.instagram} target="_blank" rel="noopener noreferrer" style={{
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    width: '3rem',
                ...
                {provider.socialMedia.twitter && (
                  <a href={provider.socialMedia.twitter} target="_blank" rel="noopener noreferrer" style={{
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    width: '3rem',
                ...
                {provider.socialMedia.linkedin && (
                  <a href={provider.socialMedia.linkedin} target="_blank" rel="noopener noreferrer" style={{
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    width: '3rem',
                ...
                {provider.socialMedia.youtube && (
                  <a href={provider.socialMedia.youtube} target="_blank" rel="noopener noreferrer" style={{
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    width: '3rem',
              ...
              <p style={{ textAlign: 'center', color: '#666' }}>No social media information available</p>
            )}
          </div>
          ...
          <div style={{ 
            ...
            <div style={{
              ...
              <p style={{ 
                ...
                <span style={{ marginRight: '10px', color: '#2E7D32', fontWeight: 'bold' }}>📱</span>
                <a href={`tel:${provider.phone}`} style={{ color: '#2E7D32', textDecoration: 'none' }}>{provider.phone}</a>
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{ 
                ...
                <span style={{ marginRight: '10px', color: '#2E7D32', fontWeight: 'bold' }}>✉️</span>
                <a href={`mailto:${provider.email}`} style={{ color: '#2E7D32', textDecoration: 'none' }}>{provider.email}</a>
              </p>
            </div>
            ...
            {provider.website && (
              <div style={{
                ...
                <p style={{ 
                  ...
                  <span style={{ marginRight: '10px', color: '#2E7D32', fontWeight: 'bold' }}>🌐</span>
                  <a href={provider.website} target="_blank" rel="noopener noreferrer" style={{ color: '#2E7D32', textDecoration: 'none' }}>{provider.website}</a>
                </p>
              </div>
            )}
          </div>
      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <div>
            {renderStars(provider.rating)}{' '}
            <span style={{ marginLeft: '10px', fontWeight: 'bold' }}> stars</span>
          </div>
        </div>
      ...
      {modalImage && (
        <div onClick={closeModal} style={{
          ...
          <div style={{
            ...
            {/* Navigation */}
            {provider.image && provider.image.length > 1 && (
              <>
      ...
      <div style={{
        ...
        <p style={{ 
          ...
          marginBottom: '2rem',
          fontSize: 'clamp(1rem, 2vw, 1.2rem)'
        }}>Contact {provider.name} today to schedule your appointment!</p>
        ...
        <div style={{
          ...
          <a href={`tel:${provider.phone}`} style={{
            ...
            <span style={{ marginRight: '8px' }}><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
...
</svg></span> Whatsapp {provider.phone}
          </a>
          
          <a href={`mailto:${provider.email}`} style={{
            background: 'white',
            color: 'green',
            textDecoration: 'none',
            padding: '12px 24px',
